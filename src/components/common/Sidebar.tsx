      ...
      <aside className="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-white to-gray-50 shadow-2xl z-50 transform transition-all duration-300 ease-in-out overflow-hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
            <Link 
              to="/" 
              className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-500 hover:to-blue-300 transition-all duration-300" 
              onClick={close}
            >
              SmartSpace
            </Link>
          ...
          <nav className="flex-1 p-4 overflow-y-auto">
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  className={`flex items-center px-4 py-3 rounded-xl transition-all duration-200 transform hover:translate-x-1
                    ${location.pathname === '/' 
                      ? 'bg-gradient-to-r from-blue-100 to-blue-50 text-blue-600 shadow-md' 
                      : 'text-gray-700 hover:bg-gray-100 hover:shadow-sm'
                    }`}
                >
                  <div className={`p-2 mr-3 rounded-lg ${location.pathname === '/' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600'}`}>
              ...
              <li>
                ...
                >
                  <div className={`p-2 mr-3 rounded-lg ${location.pathname === '/spaces' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600'}`}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
              ...
              <li>
                ...
                >
                  <div className={`p-2 mr-3 rounded-lg ${location.pathname === '/bookings' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600'}`}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
              ...
              <li>
                ...
                >
                  <div className={`p-2 mr-3 rounded-lg ${location.pathname === '/dashboard' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600'}`}>
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
          ...
          <div className="p-4 border-t border-gray-200 bg-gradient-to-t from-white to-gray-50">
            <Link
              to="/login"
              onClick={close}
              className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-400 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:from-blue-600 hover:to-blue-500 transform hover:-translate-y-1"
            >
